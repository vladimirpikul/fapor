...
$(document).ready(function(){$("#header-nav").slicknav({prependTo:$("header nav")})}),$(document).ready(function(){$(".slick-slider").slick()}),$(document).ready(function(){$("i.fas.fa-chevron-left").on("click",function(n){n.preventDefault(),$(".slick-prev").click()}),$("i.fas.fa-chevron-right").on("click",function(n){n.preventDefault(),$(".slick-next").click()})}),$(document).ready(function(){$("form.subscribe button.btn-submit").on("click",function(n){n.preventDefault();var e=$("form.subscribe input").val();if(console.log(e),0==/^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/.test(e))return alert("Invalid e-mail"),!1})});
